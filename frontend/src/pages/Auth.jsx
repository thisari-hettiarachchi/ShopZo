          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white text-sm">10,000+ Active Vendors</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(255,255,255,0.2)' }}>
                  <Check size={20} color="white" />
              ...
              {!isLogin && (
                <div className="animate-slide-in">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div
                      className={`flex flex-col items-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:-translate-y-0.5 ${formData.accountType === 'customer' ? 'shadow-md' : ''}`}
                      style={{
                        borderColor: formData.accountType === 'customer' ? 'var(--color-primary)' : 'var(--border)',
                        backgroundColor: formData.accountType === 'customer' ? 'var(--bg-muted)' : 'var(--bg-card)'
                      }}
                    ...
                    >
                      ...
                      <span className="text-sm font-semibold" style={{ color: formData.accountType === 'customer' ? 'var(--text-primary)' : 'var(--text-muted)' }}>Shop</span>
                    </div>
                    <div
                      className={`flex flex-col items-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:-translate-y-0.5 ${formData.accountType === 'vendor' ? 'shadow-md' : ''}`}
                      style={{
                        borderColor: formData.accountType === 'vendor' ? 'var(--color-primary)' : 'var(--border)',
                        backgroundColor: formData.accountType === 'vendor' ? 'var(--bg-muted)' : 'var(--bg-card)'
                      }}
